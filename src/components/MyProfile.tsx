...
<img
  src={profilePhoto || user.profile_photo || '/images/placeholder.png'}
...
/>
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536M9 11l3 3 8-8M4 20h4l12-12a2 2 0 10-2-2L6 18v2z" />
          </svg>
        </button>
        <input
          type="file"
